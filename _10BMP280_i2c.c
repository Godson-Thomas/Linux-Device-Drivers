...
static struct i2c_adapter * bmp_i2c_adapter = NULL;  /*Adapter to I2c Bus - part which connects driver to the real bus*/
static struct i2c_client * bmp280_i2c_client = NULL; /*Client :Our I2C device */
